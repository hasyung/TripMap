class RecommendDetailed < ActiveRecord::Base
  ...
  attr_accessible :name, :order, :recommend_record_id,
                  :recommend_detailed_cover_attributes, :recommend_detailed_item_cover_attributes
  ...
  with_options :as => :imageable, :class_name => 'Image', :dependent => :destroy do|assoc|
    ...
    assoc.has_one  :recommend_detailed_item_cover, :conditions => { :image_type => Image.recommend_detailed_item_cover }
  ...
  accepts_nested_attributes_for :recommend_detailed_item_cover, reject_if: ->(attr){ attr[:file].blank? }, :allow_destroy => true
